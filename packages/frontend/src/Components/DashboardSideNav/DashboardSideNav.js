  ...
  return (
    <div className={styles.sideNav}>
      ...
      <div className={styles.routesBlock}>
        ...
        >
          <DisbursalIcon className={styles.navIcons} />
          Disbursal Status
        </NavLink>
        <NavLink
          activeClassName={styles.activeNavRoute}
        ...
        >
          <SchemesIcon className={styles.navIcons} />
          Schemes
        </NavLink>
        <NavLink
          activeClassName={styles.activeNavRoute}
        ...
        >
          <ConversationsIcon className={styles.navIcons} />
          Conversations
        </NavLink>
        ...
        >
          <SettingsIcon className={classNames(styles.navIcons, styles.separatedIcons)} />
          Account Settings
        </NavLink>
      </div>
      ...
      <div className={styles.navFooter}>
        <NavLink
          ...
          to="/dashboard/faq"
        >
          <HelpIcon className={classNames(styles.navIcons, styles.separatedIcons)} />
          FAQ
        </NavLink>
      </div>
    </div>
